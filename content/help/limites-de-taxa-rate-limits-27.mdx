...
excerpt: "Passo a passo completo sobre como configurar e usar Limites de taxa (Rate Limits) no RevenueOS."
...
**Limites de taxa (Rate Limits)** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
