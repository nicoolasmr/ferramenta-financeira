...
excerpt: "Guia técnico detalhado sobre Limites de taxa (Rate Limits), incluindo configuração, melhores práticas e troubleshooting."
...
## Visão Geral
Este artigo detalha procedimentos oficiais sobre **Limites de taxa (Rate Limits)**. 
...
3. Selecione a opção **Limites de taxa (Rate Limits)**.
