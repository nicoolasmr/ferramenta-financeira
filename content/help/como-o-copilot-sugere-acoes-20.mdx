...
excerpt: "Guia técnico detalhado sobre Como o Copilot sugere ações, incluindo configuração, melhores práticas e troubleshooting."
...
## Visão Geral
Este artigo detalha procedimentos oficiais sobre **Como o Copilot sugere ações**. 
...
3. Selecione a opção **Como o Copilot sugere ações**.
