...
excerpt: "Passo a passo completo sobre como configurar e usar Como o Copilot sugere ações no RevenueOS."
...
**Como o Copilot sugere ações** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
