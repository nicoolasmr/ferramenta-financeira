...
excerpt: "Passo a passo completo sobre como configurar e usar Personalizando prompts do GPT no RevenueOS."
updatedAt: "2026-02-21"
category: "IA Copilot"
keywords: ["copilot", "tutorial", "setup"]
---

## O que é?

**Personalizando prompts do GPT** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
