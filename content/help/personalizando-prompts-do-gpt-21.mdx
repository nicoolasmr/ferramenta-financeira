...
excerpt: "Guia técnico detalhado sobre Personalizando prompts do GPT, incluindo configuração, melhores práticas e troubleshooting."
updatedAt: "2026-02-21"
category: "IA Copilot"
keywords: ["copilot", "tutorial", "guide", "docs"]
---

## Visão Geral
Este artigo detalha procedimentos oficiais sobre **Personalizando prompts do GPT**. 
...
2. No menu lateral, localize a seção **IA Copilot**.
3. Selecione a opção **Personalizando prompts do GPT**.
