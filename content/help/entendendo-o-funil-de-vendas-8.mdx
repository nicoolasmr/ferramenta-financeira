...
excerpt: "Guia técnico detalhado sobre Entendendo o funil de vendas, incluindo configuração, melhores práticas e troubleshooting."
...
## Visão Geral
Este artigo detalha procedimentos oficiais sobre **Entendendo o funil de vendas**. 
...
2. No menu lateral, localize a seção **Vendas & Clientes**.
3. Selecione a opção **Entendendo o funil de vendas**.
