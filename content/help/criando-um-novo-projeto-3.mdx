...
excerpt: "Passo a passo completo sobre como configurar e usar Criando um novo Projeto no RevenueOS."
...
**Criando um novo Projeto** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
