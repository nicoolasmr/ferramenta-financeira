...
excerpt: "Passo a passo completo sobre como configurar e usar Visão Geral do Calendário de Recebíveis no RevenueOS."
updatedAt: "2026-02-21"
category: "Pagamentos & Recebíveis"
keywords: ["payments", "tutorial", "setup"]
---

## O que é?

**Visão Geral do Calendário de Recebíveis** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
