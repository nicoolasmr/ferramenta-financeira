...
excerpt: "Passo a passo completo sobre como configurar e usar Exportando dados brutos no RevenueOS."
...
**Exportando dados brutos** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
