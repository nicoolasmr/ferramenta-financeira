---
title: "Exportando dados brutos"
excerpt: "Guia técnico detalhado sobre Exportando dados brutos, incluindo configuração, melhores práticas e troubleshooting."
...
## Visão Geral
Este artigo detalha procedimentos oficiais sobre **Exportando dados brutos**. 
...
3. Selecione a opção **Exportando dados brutos**.
