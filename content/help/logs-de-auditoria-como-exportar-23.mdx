...
excerpt: "Passo a passo completo sobre como configurar e usar Logs de Auditoria: Como exportar no RevenueOS."
...
**Logs de Auditoria: Como exportar** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
