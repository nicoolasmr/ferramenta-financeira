...
excerpt: "Passo a passo completo sobre como configurar e usar Mascaramento de dados pessoais (PII) no RevenueOS."
updatedAt: "2026-02-21"
category: "Segurança & Permissões"
keywords: ["security", "tutorial", "setup"]
---

## O que é?

**Mascaramento de dados pessoais (PII)** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
