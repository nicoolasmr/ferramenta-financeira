...
excerpt: "Passo a passo completo sobre como configurar e usar Registrando uma venda manual no RevenueOS."
updatedAt: "2026-02-21"
category: "Vendas & Clientes"
keywords: ["sales", "tutorial", "setup"]
---

## O que é?

**Registrando uma venda manual** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
