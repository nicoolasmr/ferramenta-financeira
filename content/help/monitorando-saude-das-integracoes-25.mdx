...
excerpt: "Passo a passo completo sobre como configurar e usar Monitorando saúde das integrações no RevenueOS."
...
**Monitorando saúde das integrações** é uma funcionalidade essencial para quem busca controle total sobre a operação. Nesta seção, explicaremos como configurá-la corretamente.
