...
import { DashboardMetrics, RecentSale } from "@/actions/dashboard";
...
export function DashboardClient({ metrics, recentSales }: DashboardClientProps) {
                            ...
                            {recentSales.length > 0 ? recentSales.map((sale, i) => (
                                <div key={i} className="flex items-center group cursor-default">
                                    ...
                                    <div className="ml-4 space-y-0.5">
                                        <p className="text-sm font-bold text-slate-900 dark:text-white">{sale.customerName}</p>
